...
ckpt_filename = './checkpoints/smp_test26/1.5M/FacebookModel_epoch=17_trn_loss_epoch=0.9250_trn_acc_epoch=0.0000_val_loss_epoch=0.4375_val_acc_epoch=0.9919_LIGHT.ckpt'
