...
BATCH_SIZE   = 52 #52 #132 # 64 # 22
N_WORKERS    = 20
DS_INPUT_DIR = f'./all_datasets/dataset'  # Path where "query_images", "reference_images" and "training_images" are located

BUILD_W_MATRIX = False #True
INITIAL_CKPT   = None #'./TEST26_200k_nobias_l1/lightning_logs/version_0/checkpoints/last.ckpt'
...
class ArgsT26(Args):
    ...
    n_facebook_samples   = 250_000  # 1_000_000 Facebook's training dataset
    n_imagenet_samples   = 250_000  # 1_431_167 ImageNet
    ...
    GeM_p                = 3.0
    GeM_opt_p            = True
    checkpoint_base_path = f'./TEST26_{int(arc_classnum/1000)}k_nobias_l1'
