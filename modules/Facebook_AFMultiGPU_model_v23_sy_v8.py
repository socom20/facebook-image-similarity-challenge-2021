...
DS_INPUT_DIR = f'/home/intel-spc/PycharmProjects/facebookproject/dataset/'  #
QRY_AUGS_INTENSITY = 0.5
...
N_FACEBOOK =1000000#400000 #1_000_000
N_IMAGENET =500000#400000 #  500_000
N_FRM_FACE =0 #  0#100_000

BUILD_W_MATRIX = True
INITIAL_CKPT   = './TEST23_AF_1.5M_CFG_A_oct12_1mil/lightning_logs/version_2/checkpoints/last.ckpt'
...
class ArgsT23_EffNetV2(Args):
    ...
    GeM_p                = 3.0
    GeM_opt_p            = True
    checkpoint_base_path = './TEST23_AF_1.5M_CFG_A_oct13_15mil'
