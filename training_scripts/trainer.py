...
def main(
    ...
    n_frm_face_samples:int=0,       # 476_584 FrameFaces (Google's DeepFake dataset)
    batch_size:int=32*5,
    ...
    args.n_frm_face_samples   = n_frm_face_samples
    args.arc_classnum         = n_facebook_samples + n_imagenet_samples + n_frm_face_samples
    args.checkpoint_base_path = f'./TEST26_{int(args.arc_classnum/1000)}k_nobias_l1'
    print(args)
